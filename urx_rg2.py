...
class OnRobotGripperRG2Script(URScript):
    ...
    def _rg2_command(self, target_width=110, target_force=40, payload=0.5, set_payload=False, depth_compensation=False,
                     slave=False):
...
class OnRobotGripperRG2(object):
    ...
    def open_gripper(self, target_width=110, target_force=40, payload=0.5, set_payload=False, depth_compensation=False,
                     slave=False, wait=2):
    ...
    def close_gripper(self, target_width=-10, target_force=40, payload=0.5, set_payload=False, depth_compensation=False,
                      slave=False, wait=2):
        urscript = OnRobotGripperRG2Script()
        urscript._rg2_command(target_width, target_force, payload, set_payload, depth_compensation, slave)
        self.robot.send_program(urscript())
...
if __name__ == '__main__':
    rob = urx.Robot("192.168.125.101")
    gripper = OnRobotGripperRG2(rob)

    gripper.open_gripper(60)
